  ...
  <body>
    ...
    <div id="container">
      ...
      <form class="form-signin" action="" method="POST"> 
		...
		<?php
	include("config.php"); 
	$connection =mysql_connect($db_host,$db_user)or die("errorrr...");
//echo "connection made"; 
	...
	<tr align='center'>
		...
		<td><h3>".$row["name"]."</h3><br><input type=\"submit\" name=\"like\" value=\"like\" onClick=\"changeLikeDislike()\"></td>
		<td>".$row["director"]."</td>
		<td>".$row["year"]."</td>
		<td>".$row["info"]." </td>
...
function changeLikeDislike(name){
   var dataString = 'name='+ name ;
   $("#product_flash_"+name).show();
   $("#product_flash_"+name).fadeIn(400).html
   ...
   $.ajax({
     ...
     if(result){
        ...
        if(warningMessage=='success'){
           ...
           $("#product_flash_"+name).html('&nbsp;');
           $("#product_"+name).html(successMessage);
        }else{
           var errorMessage=result.substring(position+2);
           $("#product_flash_"+name).html(errorMessage);
        }
     }
   }
  });
