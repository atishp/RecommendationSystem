...
function unLikeSiteFunction(item_id){
...
<img height="20" width="20" src="images/recsys/ssm.gif" />
   ...
   <center>
        <div class="span9" style="margin-left:250px" >
          <div class="well" >
            ...
            <p>Check out the sites you liked...!!! </p>
 ...
 <div class="panel panel-default" >
            <div class="panel-heading">
                           <center> <h3 >Favourite Sites</h3> </center>

            </div>
            <div class="panel-body">
              
         <?php  
		 $query=" SELECT * FROM `universal_sites` WHERE `id` IN
 (SELECT `item_id` FROM $username WHERE `item_domain`='sites')";
 
	$result=mysql_query($query);
	if(($row=mysql_fetch_assoc($result))== NULL )
{
echo "<h3> <font color='gray' > You have not Liked any sites Yet . . . ! ! ! </font> </h3>";
echo "<h3> <font color='gray' > Try this: </font> </h3>
	<h4> <font color='blue' > <a href= 'trending.php'> top trending</a> </font> </h4>
	<h4> <font color='blue' > <a href= 'recommend_sites.php'> My sites</a> </font> </h4>";
...
else
{
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='100px' height='100px'></td>
				<td><h3>".$row["name"]."</h3><br><input type=\"submit\" id= ".$row["id"]." name=\"unlike\" value=\"unlike\" onClick='unLikeSiteFunction(".$row["id"].")'>
