        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
               <li class="active"><a href="process_signup_music.php">Step 3</a></li>
				 <li class="active"><a href="process_signup_movies.php">Back</a></li>
...
<br>
  <body>
	...
	$query="select * from universal_music ORDER BY RAND() limit 4";
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='193px' height='300px'></td>
				...
				<br><input type="button" class="like" value="like" id=<?php echo $row["id"]; ?> onClick="likeMusicFunction(<?php echo $row["id"]; ?>)" >
				
				<br>
				<?php $id=$row["id"];
					$query1="SELECT `likes` FROM `universal_music` WHERE `id`=`$id`";
...
?>
	...
	<center>  <form align="center" action="process_signup_books.php">
	  <a href="process_signup_books.php"><button class="btn btn-success"> Next page </button></a> 
	  <form/></center>
    </div> <!-- /container -->
