...
<html lang="en">
  ...
  <body background="images/recsys/recommend_books.jpg">
...
<img height="20" width="20" src="images/recsys/ssm.gif" />
   ...
   <div class="span9" style="margin-left:250px" >
	...
	include "Functions/recommend.php";
		 ...
		 recommend_books($username,$key); 
		 
	
?>

		  
	 <center> <a class="btn btn-large btn-primary" href="recommend_books.php">Find more</a>	</center>	
		</div>	
