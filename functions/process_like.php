...
//if($act == 'like'): //if the user click on "like"
    //if(($like_count == 0)){
		...
		{
		mysql_query("INSERT INTO $username(`item_id`, `item_domain`) VALUES ('$item_id', '$item_domain')");
		
	    mysql_query("UPDATE universal_movies SET likes=likes+1 WHERE id='$item_id'");
		}
		else if($item_domain=="apps")
		{
		mysql_query("INSERT INTO $username(`item_id`, `item_domain`) VALUES ('$item_id', '$item_domain')");
