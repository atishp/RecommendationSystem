  ...
  <body>
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='193px' height='300px'></td>
				...
				<br><input type="button" class="like" value="like" id=<?php echo $row["id"]; ?> onClick="likeFunction(<?php echo $row["id"]; ?>)" ></td>
				<?php
				echo"
		<td>".$row["director"]."</td>
		<td>".$row["year"]."</td>
...
?>
	  ...
	  <form align="center" action="profile.php" >
	  <a href="process_signup_.php"><button class="btn btn-success"> Complete Sign up! </button></a> 
	  <form/>
    </div> <!-- /container -->
