        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                <li class="active"><a href="process_signup_books.php">Step 4</a></li>
				 <li class="active"><a href="process_signup_music.php">Back</a></li>
...
<br>
  <body>
	...
	$query="select * from universal_books ORDER BY RAND() limit 4";
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='193px' height='300px'></td>
				...
				<br><input type="button" class="like" value="like" id=<?php echo $row["id"]; ?> onClick="likeBookFunction(<?php echo $row["id"]; ?>)" >
				
				<br>
				<?php $id=$row["id"];
					$query1="SELECT `likes` FROM `universal_books` WHERE `id`=`$id`";
...
?>
	  ...
	  <center><form align="center" action="process_signup_sites.php">
	  <a href="process_signup_sites.php"><button class="btn btn-success"> Next page </button></a> 
	  <form/></center>
    </div> <!-- /container -->
