        ...
        <div class="span9" style="margin-left:250px;  " >
          <div class="well" >
            <h2>Hello <?php echo $username; ?></h2>
             <p>Check out the apps you liked...!!! </p>
...
<centre>
	 <div class="panel panel-info" align="center">
            <div class="panel-heading">
                           <center> <h3 >Favourite Apps</h3> </center>
            ...
            <div class="panel-body">
                ...
                <?php  
		 $query=" SELECT * FROM `universal_apps` WHERE `id` IN
 (SELECT `item_id` FROM $username WHERE `item_domain`='apps')";
...
{
echo "<h3> <font color='gray' > You have not Liked any Apps Yet . . . ! ! ! </font> </h3>";
echo "<h3> <font color='gray' > Try this: </font> </h3>
	<h4> <font color='blue' > <a href= 'trending.php'> top trending</a> </font> </h4>
	<h4> <font color='blue' > <a href= 'recommend_apps.php'> My apps</a> </font> </h4>";
...
else
{
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='100px' height='100px'></td>
				<td><h3>".$row["name"]."</h3><br><input type=\"submit\" id= ".$row["id"]." name=\"unlike\" value=\"unlike\" onClick='unLikeAppFunction(".$row["id"].")'>
