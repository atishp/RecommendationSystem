...
function unLikeBookFunction(item_id){
...
function unLikeAppFunction(item_id){
...
<img height="20" width="20" src="images/recsys/ssm.gif" />
        ...
        <div class="span9" style="margin-left:250px" >
          <div class="well" >
          <center>  <h2>Hello <?php echo $username; ?></h2>
            <p>Check out the Books liked for you ... </p>
...
<centre>
 ...
 <div class="panel panel-success" >
            ...
            <div class="panel-body">
			  ...
			  <?php  
		 $query=" SELECT * FROM `universal_books` WHERE `id` IN
 (SELECT `item_id` FROM $username WHERE `item_domain`='books')";
	$result=mysql_query($query);
	if(($row=mysql_fetch_assoc($result))== NULL )
{
echo "<h3> <font color='gray' > You have not Liked any books Yet . . . ! ! ! </font> </h3>";
echo "<h3> <font color='gray' > Try this: </font> </h3>
	<h4> <font color='blue' > <a href= 'trending.php'> top trending</a> </font> </h4>
	<h4> <font color='blue' > <a href= 'recommend_books.php'> My books</a> </font> </h4>";
...
else
{
	...
	<tr align='center'>
		<td><img src='".$row["image"]."' width='100px' height='100px'></td>
				<td><h3>".$row["name"]."</h3><br><input type=\"submit\" id= ".$row["id"]." name=\"unlike\" value=\"unlike\" onClick='unLikeBookFunction(".$row["id"].")'>
